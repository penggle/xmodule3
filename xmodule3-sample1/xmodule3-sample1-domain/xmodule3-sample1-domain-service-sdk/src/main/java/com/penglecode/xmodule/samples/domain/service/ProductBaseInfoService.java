...
public interface ProductBaseInfoService {
     ...
     * 批量创建商品基本信息
     *
     * @param productBases     - 被保存的领域对象集合
     */
    void bulkCreateProductBase(List<ProductBaseInfo> productBases);
     ...
     * 根据ID批量修改商品基本信息
     *
     * @param productBases     - 被保存的领域对象集合(id字段必须有值)
     */
    void bulkModifyProductBaseById(List<ProductBaseInfo> productBases);
