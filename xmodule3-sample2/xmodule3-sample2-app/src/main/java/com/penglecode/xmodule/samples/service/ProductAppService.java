...
public interface ProductAppService {
     ...
     * @return 返回完整的领域对象信息
     */
    Product getProductById(Long id, boolean cascade);
     ...
     * @return 返回完整的领域对象信息
     */
    List<Product> getProductListByIds(List<Long> ids, boolean cascade);
     ...
     * @return 返回完整的领域对象列表
     */
    List<Product> getProductListByPage(Product condition, Page page, boolean cascade);
     ...
     */
    void forEachProduct(Consumer<Product> consumer);
     ...
     * @param consumer  - 遍历元素的Consumer
     */
    void forEachProduct(ObjIntConsumer<Product> consumer);
